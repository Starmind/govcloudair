...
type GuestCustomizationSection struct {
	...
	CustomizationScript   *CustomizationScript `xml:"CustomizationScript,omitempty"`   // Script to run on guest customization. The entire script must appear in this element. Use the XML entity &#13; to represent a newline. Unicode characters can be represented in the form &#xxxx; where xxxx is the character number.
...
// Wrap customization script in CDATA helper
type CustomizationScript struct {
	XMLName xml.Name `xml:"CustomizationScript"`
